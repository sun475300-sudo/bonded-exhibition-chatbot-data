...
CATEGORY_KEYWORDS = {
    "GENERAL": [
        ...
        "주최", "개최", "준비", "행사 준비", "주최하려면", "운영인 자격",
        "자격 요건", "이용 자격", "이용할 수", "누가 이용"
    ],
    "LICENSE": [
        "특허", "운영", "설치", "특허기간", "특허신청",
        "특허장소", "운영인", "설치특허", "갱신", "연장", "변경",
        "특허 연장", "기간 연장",
        "특허 신청", "특허 취소", "수수료", "취소 사유",
        "특허 갱신", "특허 연장", "신청 수수료", "신청 비용"
    ],
    "IMPORT_EXPORT": [
        "반입", "반출", "반출입", "물품검사",
        ...
        "돌려보내", "잔류", "남은 물품", "미반출",
        "해외로", "세관 검사", "반입 검사",
        "가액", "가격 신고", "물품 이동", "보세전시장 간",
        "다른 전시장", "이동 가능", "보세운송",
        "남으면", "전시 종료", "옮길", "이동"
    ],
    "EXHIBITION": [
        "전시", "전시물", "장치", "진열", "디스플레이", "전시회",
        "박람회", "전람회", "시연", "데모", "시범", "체험",
        "사용 범위", "전시 목적", "전시 가능",
        "전시 기간", "전시 물품", "물품 교체", "전시 중",
        "촬영", "홍보 활동",
        "어디까지 사용", "사용할 수 있는 범위", "장치된 물품"
    ],
    "SALES": [
    ...
    "FOOD_TASTING": [
        "시식", "식품", "음식", "요건확인", "세관장확인",
        "식약처", "검역", "위생", "시식용", "잔량", "폐기",
        "남은 식품", "한글 표시", "라벨", "식품 표시"
    ],
    "DOCUMENTS": [
        "서류", "신고서", "신청서", "구비서류", "제출", "양식",
        "서식", "첨부", "문서", "반출입신고서", "허가 신청",
        "인보이스", "송장", "구비 서류", "첨부서류",
        "어떤 서류", "필요한 서류", "서류 필요", "서류가 필요",
        "보고서", "종료 보고", "결과 보고", "운영 종료", "신청 구비서류"
    ],
    "PENALTIES": [
        "벌칙", "제재", "과태료", "벌금", "처벌", "위반", "처분",
        "불이익", "과징금", "무허가", "밀수", "업무 정지",
        "의무 위반", "허가 없이", "면허 없이",
        "어떻게 되나", "처벌받", "걸리면",
        "밀수출입", "밀수입", "무허가 반출",
        "의무위반", "특허 취소", "취소되나요"
...
# 도메인 우선순위: LICENSE가 PENALTIES보다 높아야 "특허 취소 사유" 질문이
# LICENSE로 올바르게 분류됨. PENALTIES가 LICENSE보다 높으면 PENALTIES로 잘못 감.
# 단, 동점 시에만 우선순위가 적용되므로 각 카테고리의 점수(히트 수)가 다르면
# 점수가 높은 카테고리가 이긴다.
CATEGORY_PRIORITY = {
    "FOOD_TASTING": 1,
    "SAMPLE": 2,
